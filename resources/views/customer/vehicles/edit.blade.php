<x-customer.layouts.app :title="'Edit Vehicle'">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mt-3 pt-4 pb-2 mb-3 border-bottom">
        <h1 class="h2">Edit Vehicle - {{ $vehicle->vehicle_no }}</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <a href="{{ route('customer.vehicles.show', $vehicle) }}" class="btn btn-info">
            ...
            <form method="POST" action="{{ route('customer.vehicles.update', $vehicle) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date"
                               ...
                               value="{{ old('date_of_purchase', $vehicle->date_of_purchase->format('Y-m-d')) }}"
                               max="{{ date('Y-m-d') }}"
                               required>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-check">
                            <input class="form-check-input"
                                   ...
                                   value="1"
                                   {{ old('registration_status', $vehicle->registration_status) ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="{{ route('customer.vehicles.show', $vehicle) }}" class="btn btn-secondary ms-2">
                            Cancel
                        </a>
                    </div>
                </div>
    ...
    <script>
        document.getElementById('vehicle_no').addEventListener('input', function() {
            ...
            if (vehicleNo.length >= 6 && vehicleNo !== '{{ $vehicle->vehicle_no }}') {
                // Check availability via AJAX
                fetch(`{{ route('customer.vehicles.check-availability') }}?vehicle_no=${vehicleNo}&vehicle_id={{ $vehicle->id }}`)
